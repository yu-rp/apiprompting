...
from llava.transformers import PreTrainedModel, PreTrainedTokenizer, PreTrainedTokenizerFast
from llava.transformers.modeling_outputs import BaseModelOutputWithPast, CausalLMOutputWithPast
